...
module.exports = {
  ...
  async execute(_client, msg, _args) {
    ...
    msg.channel.send(
      character1.emotes.pog + ' <:doushitenoodles:755874703788474538> ' + character2.emotes.pog,
    );
    const emoteString =
      Math.random() >= 0.5
        ? character1.emotes.win + ' <:doushitenoodles:755874703788474538> ' + character2.emotes.sad
        : character1.emotes.sad + ' <:doushitenoodles:755874703788474538> ' + character2.emotes.win;
    await timer(3000);
